// Local fork of pi-thinking-steps for @earendil-works/pi-coding-agent 0.75.x (Pi 0.75.4).
// Source: https://github.com/crustyhacker/pi-thinking-steps — adapted package imports only.
...
import { clearActiveThinkingState, clearThinkingMessageOwnership, getCurrentThinkingScopeKey, getPatchCleanup, getPatchRefCount, getThinkingStepsMode, nextThinkingRefreshLabel, recordThinkingMessageScope, registerThinkingPatchRelease, resolveThinkingMessageScope, setActiveThinkingState, setCurrentThinkingScopeKey, setThinkingStepsMode, takeThinkingPatchRelease } from "./state.js";
...
export default function thinkingStepsExtension(pi: ExtensionAPI): void {
	...
	pi.on("message_update", async (event) => {
		...
		if (assistantEvent.type === "thinking_delta") {
			const delta = "delta" in assistantEvent && typeof assistantEvent.delta === "string"
