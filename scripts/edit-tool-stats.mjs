...
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".pix/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.pix/agent/sessions)
