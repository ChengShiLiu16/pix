...
try {
	...
	const baseBuild = await build({
		stdin: {
			contents: `import { complete } from "@chengshiliu16/pix-ai/base";\nimport { Agent } from "@chengshiliu16/pix-agent-core/base";\nconsole.log(typeof complete, typeof Agent);\n`,
	...
	await build({
		stdin: {
			contents: `import { register as registerAnthropic } from "@chengshiliu16/pix-ai/anthropic";\nimport { register as registerOpenAICompletions } from "@chengshiliu16/pix-ai/openai-completions";\nimport { register as registerOpenRouterImages } from "@chengshiliu16/pix-ai/openrouter-images";\nconsole.log(typeof registerAnthropic, typeof registerOpenAICompletions, typeof registerOpenRouterImages);\n`,
			resolveDir: process.cwd(),
