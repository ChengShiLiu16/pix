import { createAssistantMessageEventStream, Type } from "@chengshiliu16/pix-ai";
import { complete, getModel, getProviders, streamSimple } from "@chengshiliu16/pix-ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
