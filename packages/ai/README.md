...
```bash
npm install @earendil-works/pix-ai
```

TypeBox exports are re-exported from `@earendil-works/pix-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@earendil-works/pix-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@earendil-works/pix-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@earendil-works/pix-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@earendil-works/pix-ai';
...
```typescript
import { getImageModel, generateImages } from '@earendil-works/pix-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@earendil-works/pix-ai';
...
```typescript
import { getModel, stream } from '@earendil-works/pix-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@earendil-works/pix-ai';
...
```typescript
import { Model, stream } from '@earendil-works/pix-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@earendil-works/pix-ai';
...
```typescript
import { getModel, complete, Context } from '@earendil-works/pix-ai';
...
```typescript
import { Context, getModel, complete } from '@earendil-works/pix-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@earendil-works/pix-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@earendil-works/pix-ai';
...
```bash
npx @earendil-works/pix-ai login              # interactive provider selection
npx @earendil-works/pix-ai login anthropic    # login to specific provider
npx @earendil-works/pix-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@earendil-works/pix-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@earendil-works/pix-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@earendil-works/pix-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@earendil-works/pix-ai`
