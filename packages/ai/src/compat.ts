 ...
 *
 * Existing apps switch imports from "@chengshiliu16/pix-ai" to
 * "@chengshiliu16/pix-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@chengshiliu16/pix-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@chengshiliu16/pix-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@chengshiliu16/pix-ai/providers/all" or `Models.getProviders()`. */
