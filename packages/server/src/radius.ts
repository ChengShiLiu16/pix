...
import type { OAuthCredential } from "@chengshiliu16/pix-ai";
import { readStoredCredential } from "@chengshiliu16/pix-coding-agent";
...
export function getRadiusAccessToken(): string {
	...
	throw new Error("Radius credentials are required in ~/.pix/agent/auth.json or RADIUS_API_KEY");
}
