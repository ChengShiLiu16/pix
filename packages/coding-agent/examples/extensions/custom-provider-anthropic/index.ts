 ...
 *   pix -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... pix -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (pix: ExtensionAPI) {
	pix.registerProvider("custom-anthropic", {
