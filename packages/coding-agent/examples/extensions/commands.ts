 ...
 * Commands Extension
 *
 * Demonstrates the pix.getCommands() API by providing a /commands command
...
export default function commandsExtension(pix: ExtensionAPI) {
	pix.registerCommand("commands", {
