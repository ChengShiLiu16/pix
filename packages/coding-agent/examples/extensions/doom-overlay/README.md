...
Play DOOM as an overlay in pix. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
pix --extension ./examples/extensions/doom-overlay
```
