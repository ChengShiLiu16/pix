 ...
 * (logo + keybinding hints) with a custom component showing the pix mascot.
 */

import type { ExtensionAPI, Theme } from "@chengshiliu16/pix-coding-agent";
import { VERSION } from "@chengshiliu16/pix-coding-agent";

// --- PIX MASCOT ---
// Based on pi_mascot.ts - the pix agent character
...
export default function (pix: ExtensionAPI) {
	...
	pix.registerCommand("builtin-header", {
