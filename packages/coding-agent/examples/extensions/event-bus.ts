 ...
 *
 * Shows pix.events for communication between extensions. One extension
...
export default function (pix: ExtensionAPI) {
	...
	pix.events.on("my:notification", (data) => {
