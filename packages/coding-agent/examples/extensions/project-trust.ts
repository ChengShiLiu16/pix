 ...
 *
 *   mkdir -p ~/.pix/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.pix/agent/extensions/
 *
 * Or:
 *
...
import type { ExtensionAPI, ProjectTrustEventResult } from "@chengshiliu16/pix-coding-agent";
