 ...
 * working indicator shown while pix is streaming a response.
 *
 * Usage:
 *   pix --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore pix's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@chengshiliu16/pix-coding-agent";
...
export default function (pix: ExtensionAPI) {
	...
	pix.registerCommand("working-indicator", {
