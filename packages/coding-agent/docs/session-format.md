...
Source on GitHub ([pix](https://github.com/ChengShiLiu16/pix)):
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/ChengShiLiu16/pix/blob/main/packages/coding-agent/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/coding-agent/src/core/messages.ts`](https://github.com/ChengShiLiu16/pix/blob/main/packages/coding-agent/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
- [`packages/ai/src/types.ts`](https://github.com/ChengShiLiu16/pix/blob/main/packages/ai/src/types.ts) - Base message types (UserMessage, AssistantMessage, ToolResultMessage)
- [`packages/agent/src/types.ts`](https://github.com/ChengShiLiu16/pix/blob/main/packages/agent/src/types.ts) - AgentMessage union type

For TypeScript definitions in your project, inspect `node_modules/@chengshiliu16/pix-coding-agent/dist/` and `node_modules/@chengshiliu16/pix-ai/dist/`.
...
- `fromHook`: `true` if generated by an extension, `false`/`undefined` if pix-generated (legacy field name)
...
Session metadata (e.g., user-defined display name). Set via `/name`, `--name` / `-n`, or `pix.setSessionName()` in extensions.
