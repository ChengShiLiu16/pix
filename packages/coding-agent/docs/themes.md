...
- Project: `.pix/themes/*.json` (only after the project is trusted)
- Packages: `themes/` directories or `pix.themes` entries in `package.json`
...
```json
{
  "$schema": "https://raw.githubusercontent.com/ChengShiLiu16/pix/main/packages/coding-agent/src/modes/interactive/theme/theme-schema.json",
  "name": "my-theme",
  "vars": {
    "primary": "#00aaff",
    "secondary": 242
