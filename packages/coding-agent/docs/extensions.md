...
| Package | Purpose |
|---------|---------|
| `@earendil-works/pix-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@earendil-works/pix-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@earendil-works/pix-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@earendil-works/pix-coding-agent";
...
```typescript
import { isBashToolResult } from "@earendil-works/pix-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@earendil-works/pix-coding-agent";
...
```typescript
import { SessionManager } from "@earendil-works/pix-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@earendil-works/pix-tui";
...
```typescript
import { withFileMutationQueue } from "@earendil-works/pix-coding-agent";
...
**Important:** Use `StringEnum` from `@earendil-works/pix-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@earendil-works/pix-coding-agent";
...
```typescript
import { keyHint } from "@earendil-works/pix-coding-agent";
...
```typescript
import { Text, Component } from "@earendil-works/pix-tui";
...
import { matchesKey } from "@earendil-works/pix-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@earendil-works/pix-coding-agent";
