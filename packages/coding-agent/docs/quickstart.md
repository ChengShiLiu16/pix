...
# pnpm
pnpm remove -g @chengshiliu16/pix-coding-agent

# Yarn
yarn global remove @chengshiliu16/pix-coding-agent

# Bun
bun uninstall -g @chengshiliu16/pix-coding-agent
```
...
Use `/model` or Ctrl+L to choose a model. Use Shift+Tab to cycle thinking level. Use Ctrl+P / Shift+Ctrl+P to cycle through available models.
