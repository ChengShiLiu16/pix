...
Pix supports subscription-based providers via OAuth and API key providers via environment variables or auth file. For each provider, pix knows all available models. The list is updated with every pix release.
