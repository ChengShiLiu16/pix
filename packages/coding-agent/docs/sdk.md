...
```bash
npm install @earendil-works/pix-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@earendil-works/pix-coding-agent";
...
The `Agent` class (from `@earendil-works/pix-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { AuthStorage, ModelRegistry } from "@earendil-works/pix-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@earendil-works/pix-coding-agent";
...
import { createAgentSession, defineTool } from "@earendil-works/pix-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@earendil-works/pix-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@earendil-works/pix-coding-agent";
