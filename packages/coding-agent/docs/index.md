...
```bash
npm uninstall -g @earendil-works/pix-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @earendil-works/pix-coding-agent`, `yarn global remove @earendil-works/pix-coding-agent`, or `bun uninstall -g @earendil-works/pix-coding-agent`.
