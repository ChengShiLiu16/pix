    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="pix-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="pix-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'pix-share:v1:sidebar-width';
