...
import type { RetryCallbacks, RetryPolicy } from "@chengshiliu16/pix-ai";
import { contentText } from "@chengshiliu16/pix-ai";
import type { Model, SimpleStreamOptions, Usage } from "@chengshiliu16/pix-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from pix-generated summaries (fromHook !== true), not extension-generated ones
