...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@chengshiliu16/pix-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@chengshiliu16/pix-ai/compat";
...
export interface CreateAgentSessionOptions {
	 ...
	 * - "builtin": disable the default built-in tools (read, bash, edit, write, ls)
	 ...
	 *
	 * When omitted, pix enables the default built-in tools (read, bash, edit, write, ls)
...
export async function createAgentSession(options: CreateAgentSessionOptions = {}): Promise<CreateAgentSessionResult> {
	...
	agent = new Agent({
		...
		prepareNextTurnWithContext: (turnContext) => {
