...
const MIGRATION_GUIDE_URL =
	"https://github.com/ChengShiLiu16/pix/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/ChengShiLiu16/pix/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.pix/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.pix/agent/ instead of
 * ~/.pix/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: https://github.com/ChengShiLiu16/pix/issues/320
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by pix, so only warn if it has other files.
 */
