...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/ChengShiLiu16/pix/releases/latest`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.PIX_PACKAGE_DIR ?? process.env.PI_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// User Config Paths (~/.pix/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.pix/agent/) */
