...
describe("SettingsManager", () => {
	...
	describe("project trust", () => {
		...
		it("should read default project trust from global settings only", () => {
			...
			writeFileSync(join(projectDir, ".pix", "settings.json"), JSON.stringify({ defaultProjectTrust: "never" }));
	...
	describe("project settings directory creation", () => {
		...
		it("should create .pix folder when writing project settings", async () => {
			...
			expect(existsSync(join(projectDir, ".pix", "settings.json"))).toBe(true);
		});
	});
	...
	describe("httpIdleTimeoutMs", () => {
		...
		it("should use merged global and project settings", () => {
			...
			writeFileSync(join(projectDir, ".pix", "settings.json"), JSON.stringify({ httpIdleTimeoutMs: 0 }));
	...
	describe("getSessionDir", () => {
		...
		it("should return project sessionDir, overriding global", () => {
			...
			writeFileSync(join(projectDir, ".pix", "settings.json"), JSON.stringify({ sessionDir: "./sessions" }));
			const manager = SettingsManager.create(projectDir, agentDir);
