...
import type { OAuthCredentials } from "@chengshiliu16/pix-ai";
import { getModel, streamSimple } from "@chengshiliu16/pix-ai/compat";
import { builtinProviders } from "@chengshiliu16/pix-ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.pix/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".pix", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.pix/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pix/agent/auth.json
 */
