...
/**
 * Regression test for https://github.com/ChengShiLiu16/pix/issues/2791
 *
...
process.env.PIX_CODING_AGENT_DIR = "${agentDir}";
...
`,
		...
		try {
			_stdout = execFileSync(process.execPath, [scriptPath], {
				timeout: 10000,
				encoding: "utf-8",
				env: { ...process.env, PIX_CODING_AGENT_DIR: agentDir },
