...
- Fixed overlay focus restoration so non-capturing overlays remain interactive after UI rerenders and explicit focus release ([#5235](https://github.com/ChengShiLiu16/pix/pull/5235) by [@nicobailon](https://github.com/nicobailon)).
- Fixed tab width accounting in column slicing and overlay compositing so tab-containing output cannot exceed the terminal width ([#5218](https://github.com/ChengShiLiu16/pix/issues/5218)).
...
- Clarified the IME hardware cursor docs to state that cursor visibility remains opt-in ([#5200](https://github.com/ChengShiLiu16/pix/issues/5200)).
...
- Added an opt-in Markdown renderer option to preserve source ordered-list markers for transcript rendering ([#5013](https://github.com/ChengShiLiu16/pix/issues/5013)).
...
- Replaced the optional `koffi` dependency for Windows VT input with a tiny vendored native helper, reducing install size while preserving Shift+Tab handling ([#4480](https://github.com/ChengShiLiu16/pix/issues/4480)).
...
- Added markdown list-item wrapping that preserves indentation for wrapped continuation lines ([#4327](https://github.com/ChengShiLiu16/pix/pull/4327) by [@Perlence](https://github.com/Perlence)).

### Fixed

- Fixed markdown task-list checkbox rendering ([#4379](https://github.com/ChengShiLiu16/pix/pull/4379) by [@Perlence](https://github.com/Perlence)).
- Fixed markdown rendering robustness for very large markdown files ([#4463](https://github.com/ChengShiLiu16/pix/pull/4463) by [@ndanielherrera](https://github.com/ndanielherrera)).
- Fixed Kitty image placement when the viewport is shorter than the rendered image ([#4461](https://github.com/ChengShiLiu16/pix/pull/4461) by [@xu0o0](https://github.com/xu0o0)).
- Fixed WezTerm Kitty keyboard protocol edge cases so escape handling remains correct ([#4482](https://github.com/ChengShiLiu16/pix/pull/4482) by [@Felixoid](https://github.com/Felixoid)).
